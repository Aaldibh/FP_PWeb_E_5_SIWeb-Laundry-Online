...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $result = loginAs_Owner($username, $password);

    if ($result == "success") {
        header("location:./_ownerHome.php");
    } else if($result == "failed"){
        header("location:./loginOwner.php?pesan=gagal");
    } else if ($result == "null"){
        header("location:./loginOwner.php?pesan=null");
    }
}
?>
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    ...
                    <div class="panel">
                        <div class="panel-body">
                            ...
                            <a href="../_login.php" type ="button" class="btn btn-primary">Kembali</a>
